...
function Image(data:ImageFile){
    ...
    return(
        <div 
          className= "bg-center bg-cover bg-no-repeat w-2/6 h-200 px-20 sm:h-200 sm:w-100 md:h-200 cursor-pointer sm:h-200 sm:w-1/4 md:h-200 md:w-1/6 rounded-xl border border-gray-500 border-dashed flex flex-col items-center justify-center relative mb-2" 
          style = {styling}
        >
